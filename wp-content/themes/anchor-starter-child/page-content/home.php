<?php
/**
 * Home (front page) — direct-PHP.
 *
 * Thirteen bespoke Deka sections. Edit freely — each section is its own
 * anchor_render_section() call. Props match the old config/pages/home.php
 * exactly so output is byte-equivalent with the pre-migration render.
 */
...
anchor_render_section( [
	...
	'props' => [
		...
		'heading_lines' => [
			[ 'text' => 'The standard' ],
			[ 'text' => 'of ', 'italic' => 'precision light' ],
		...
		'stats'         => [
			[ 'num' => '44',  'sup' => 'yrs', 'cap' => 'Italian engineering' ],
			[ 'num' => '30k', 'sup' => '+',   'cap' => 'Systems placed worldwide' ],
		],
		'primary_cta'   => [ 'label' => 'Explore the Instruments', 'url' => '#products' ],
		'background_video' => [
			'enabled' => true,
...
anchor_render_section( [
	...
	'props' => [
		...
		'specs'          => [
			...
			[ 'k' => 'Pulse',       'v' => 'Free-running · Pulsed'       ],
			[ 'k' => 'Delivery',    'v' => 'Fiber · 300 µm'              ],
		],
		'primary_cta'    => [ 'label' => 'Schedule a Private Demo',            'url' => '#final' ],
		'secondary_cta'  => [ 'label' => 'Download the Clinical Dossier',     'url' => '#'      ],
	],
] );
...
anchor_render_section( [
	...
	'props' => [
		...
		'specs'          => [
			...
			[ 'k' => 'Delivery',   'v' => '7-joint arm'                   ],
			[ 'k' => 'Modes',      'v' => 'CW · Pulsed · Super-Pulsed'    ],
		],
		'primary_cta'    => [ 'label' => 'Request the US-20D Dossier', 'url' => '#final' ],
		'secondary_cta'  => [ 'label' => 'See indications',            'url' => '#'      ],
	],
] );

// 07 — Showcase (SmartXide Ultraspeed 2)
anchor_render_section( [
	'type'  => 'deka_showcase',
	'props' => [
		'index'          => '— 05.02',
		...
		'specs'          => [
			...
			[ 'k' => 'Indications',  'v' => 'Surgical · Peri-implant'       ],
		],
		'primary_cta'    => [ 'label' => 'Schedule a SX² Demo',          'url' => '#final' ],
		'secondary_cta'  => [ 'label' => 'Download the PSD™ whitepaper', 'url' => '#'      ],
	],
] );
...
anchor_render_section( [
	...
	'props' => [
		...
		'metrics' => [
			[ 'num' => '–62', 'sup' => '%', 'label' => 'Reduction in post-operative discomfort vs. conventional modality' ],
			[ 'num' => '2.4', 'sup' => '×', 'label' => 'Faster soft-tissue healing observed at 14 days' ],
			[ 'num' => '0.98',              'label' => 'Clinician reliability score across 1,200+ SmartXide cases' ],
			[ 'num' => '+34', 'sup' => '%', 'label' => 'Practice case acceptance when laser is offered first' ],
		],
	],
] );
...
anchor_render_section( [
	...
	'props' => [
		...
		'logos' => [
			...
			[ 'name' => 'Karolinska',          'mono' => true ],
			[ 'name' => "King's College London" ],
			[ 'name' => 'UCSF Dental',         'mono' => true ],
			[ 'name' => 'Tokyo Medical' ],
			[ 'name' => 'USC Ostrow',          'mono' => true ],
		],
	],
] );
...
anchor_render_section( [
	...
	'props' => [
		...
		'primary_cta'   => [ 'label' => 'Schedule a Private Demo',      'url' => '/contact/' ],
		'secondary_cta' => [ 'label' => 'Speak with a Clinical Advisor', 'url' => '/contact/' ],
	],
] );
