 ...
 * Home v3 — pure PHP.
 *
 * Editorial homepage variant 3 (with hero poster image). CSS lives in
 * assets/css/home-v3.css; JS in assets/js/home-v3.js. Both are enqueued
 * by functions.php when this page is the queried slug.
 *
  ...
  <div class="container hero-inner">
    ...
    <div>
      <h1 class="display hero-headline">
        ...
        <span class="line"><span style="color: rgb(185, 167, 255);">of <em style="color: rgb(185, 167, 255);">precision</em> light</span></span>
...
<section class="capabilities" id="technology" data-section-type="capabilities">
  <div class="container">
    ...
    <div class="cap-head">
      <h2 class="display reveal">Four instruments of <em style="color: rgb(139, 143, 179);">clinical certainty</em>.</h2>
    ...
    <div class="flagship-wrap">
      ...
      <div class="flagship-content">
        ...
        <div class="flagship-ctas reveal">
          <a class="btn-primary" href="#final" style="background-color: rgb(185, 167, 255);">
  ...
  <div class="container">
    ...
    <div class="sc-wrap">
      <div class="sc-content">
        ...
        <h3 class="display reveal">Pulse Shape Design.<br>A CO₂ <em style="color: rgb(185, 167, 255);">you can't feel</em><br>arrive.</h3>
        <p class="sc-lede reveal">
